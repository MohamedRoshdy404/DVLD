...
using static DVLD_Buisness.clsApplicationsBuisnessLayer;
...
namespace DVLD_Buisness
{
    public class clsLocalDrivingLicenseApplicationBL : clsApplicationsBuisnessLayer
    {
        ...
        public static clsLocalDrivingLicenseApplicationBL FindByApplicationID(int ApplicationID)
        {
           
            int LocalDrivingLicenseApplicationID = -1, LicenseClassID = -1;

            bool IsFound = clsLocalDrivingLicenseApplicationDA.GetLocalDrivingLicenseApplicationInfoByApplicationID
        ...
        {
            return clsLocalDrivingLicenseApplicationDA.DoesAttendTestType(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);
        }

        public byte TotalTrialsPerTest(clsTestType.enTestType TestTypeID)
        {
            return clsLocalDrivingLicenseApplicationDA.TotalTrialsPerTest(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);
        }
