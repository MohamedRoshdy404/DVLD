...
namespace ProjectDVLD.Applications.Rlease_Detained_License
{
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            _dtDetainedLicenses = clsDetainedLicenseBL.GetAllDetainedLicenses();
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            lblTotalRecords.Text = dgvDetainedLicenses
                .Rows.Count.ToString();
        }
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PersonID = clsLicenseBL.Find(LicenseID).DriverInfo.PersonID;
